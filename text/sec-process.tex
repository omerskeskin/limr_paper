...
that unit $\pp triangleleft \textbf{0}$ in order to reuse some of the lemmas from \cite{srpaper}
...
for the advantages of this approaches see \cref{remark-reactive-justif}.
\subsubsection{Semantics With Silent Transitions}
