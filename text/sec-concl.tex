...
We have also mechanised many of the results in Coq, with the soundness proof being the most involved
of them.  
\subsection{Future Work}
As far as the Coq implementation is concerned, an obvious next step would be to actually finish 
...
of the results of this paper would allow us to extract Coq programs that are certifiably live,
