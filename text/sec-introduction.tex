...
for typed sessions. Our type system uses an \textit{association} relation ($\assoc$) \cite{LessIsMoreRevisited,pischke2025}
...
\begin{enumerate}
    ...
    then the labels and payload types of $\pp$ and $\pq$ cohere.
...
a new typing relation.

As with \cite{srpaper}, our implementation heavily uses coinduction. \todo{fill it out}.
