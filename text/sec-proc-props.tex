...
\end{tcolorbox}
We  now detail the proof that typed sessions are live. 
...
the \lstin{constructive_indefinite_description} axiom to construct 
a cosequence as a \lstin{CoFixpoint}.
...
Correctness of the algorithm follows from \cref{theo-sub-red} and \cref{theo-sess-fid}.
\end{proof}
