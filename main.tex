...
\input{text/sec-introduction.tex}
\input{text/sec-process}
\input{text/sec-mpst_defs}
\input{text/sec-lts-semantics.tex}
\input{text/sec-props.tex}
\input{text/sec-proc-props.tex}
\input{text/sec-concl.tex}
